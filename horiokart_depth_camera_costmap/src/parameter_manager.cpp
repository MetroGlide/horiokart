    ...
    namespace depth_camera_costmap
    {
        ...
        DepthCameraCostmapParams ParameterManager::getParams()
        {
            ...
            auto declare_and_get = [&](auto *n)
            {
                ...
                n->declare_parameter("grid_resolution", params.grid_resolution);
                ...
                n->get_parameter("grid_resolution", params.grid_resolution);
