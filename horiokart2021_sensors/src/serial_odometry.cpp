...
OdometryData SerialOdometry::parse(std::vector<uint8_t> ret)
{
    ...
    // odom.x = double(((int32_t)retbuf[2]) << 24 | ((int32_t)retbuf[3]) << 16 | ((int32_t)retbuf[4]) << 8 | ((int32_t)retbuf[5])) / 1000;
    // odom.y = double((int32_t)retbuf[6]<<24 | (int32_t)retbuf[7]<<16 | (int32_t)retbuf[8]<<8 | retbuf[9])/1000;
    // odom.th = double((uint16_t)retbuf[10]<<8 | retbuf[11])/10000;

    // odom.vx = double((int16_t)retbuf[12]<<8 | retbuf[13])/1000;
    // odom.vy = double((int16_t)retbuf[14]<<8 | retbuf[15])/1000;
    // odom.vth = double((int16_t)retbuf[16]<<8 | retbuf[17])/10000;
