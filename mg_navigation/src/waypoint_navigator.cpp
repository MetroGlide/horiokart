#include "mg_navigation/waypoint_navigator.hpp"
...
nav2_util::CallbackReturn WaypointNavigator::on_configure(const rclcpp_lifecycle::State & /*state*/)
{
  ...
  action_server_ = std::make_unique<ActionServer>(
    ...
    std::bind(&WaypointNavigator::followWaypoints, this));
...
nav2_util::CallbackReturn WaypointNavigator::on_activate(const rclcpp_lifecycle::State & /*state*/)
{
  ...
  dyn_params_handler_ = node->add_on_set_parameters_callback(
    std::bind(&WaypointNavigator::dynamicParametersCallback, this, _1));
...
nav2_util::CallbackReturn WaypointNavigator::on_deactivate(
...
nav2_util::CallbackReturn WaypointNavigator::on_cleanup(const rclcpp_lifecycle::State & /*state*/)
{
...
nav2_util::CallbackReturn WaypointNavigator::on_shutdown(const rclcpp_lifecycle::State & /*state*/)
{
  RCLCPP_INFO(get_logger(), "Shutting down");
  return nav2_util::CallbackReturn::SUCCESS;
}

void WaypointNavigator::followWaypoints()
{
...
void WaypointNavigator::resultCallback(
...
void WaypointNavigator::goalResponseCallback(
...
rcl_interfaces::msg::SetParametersResult WaypointNavigator::dynamicParametersCallback(
...
int main(int argc, char ** argv)
{
  ...
  auto node = std::make_shared<mg_navigation::WaypointNavigator>();
...
RCLCPP_COMPONENTS_REGISTER_NODE(mg_navigation::WaypointNavigator)
