#include "horiokart_navigation/waypoint_navigator.hpp"
...
namespace horiokart_navigation
{
    ...
    WaypointNavigator::on_configure(const rclcpp_lifecycle::State & /*state*/)
    {
        ...
        action_server_ = std::make_unique<ActionServer>(
            ...
            get_node_logging_interface(),
            get_node_waitables_interface(),
            "follow_waypoints", std::bind(&WaypointNavigator::followWaypoints, this));
    ...
    nav2_util::CallbackReturn
    WaypointNavigator::on_activate(const rclcpp_lifecycle::State & /*state*/)
    {
    ...
    nav2_util::CallbackReturn
    WaypointNavigator::on_deactivate(const rclcpp_lifecycle::State & /*state*/)
    {
    ...
    nav2_util::CallbackReturn
    WaypointNavigator::on_cleanup(const rclcpp_lifecycle::State & /*state*/)
    {
    ...
    nav2_util::CallbackReturn
    WaypointNavigator::on_shutdown(const rclcpp_lifecycle::State & /*state*/)
    {
    ...
    void
    WaypointNavigator::followWaypoints()
    {
    ...
    void
    WaypointNavigator::resultCallback(
    ...
    void
    WaypointNavigator::goalResponseCallback(
    ...
    WaypointNavigator::dynamicParametersCallback(std::vector<rclcpp::Parameter> parameters)
    {
...
int main(int argc, char **argv)
{
    ...
    auto node = std::make_shared<horiokart_navigation::WaypointNavigator>();
...
RCLCPP_COMPONENTS_REGISTER_NODE(horiokart_navigation::WaypointNavigator)
